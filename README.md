...
- battle feedback smoke tests for action logs, cell flashes, result banners, polished board frame, refined legend copy, material-style cell shadows, and pseudo-3D rock visual state
