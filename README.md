...
Phase 3 skill basics are playable:
...
- skill bar with target highlighting
- first three skill prototypes: Li Yan, Sui Yan, and Yu Jing
...
- skill smoke tests for rock creation, rock removal, and warning metadata
