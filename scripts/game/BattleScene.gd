...
func _create_styles() -> void:
	empty_style = _make_cell_style()
	spirit_style = _make_cell_style()
	rock_style = _make_cell_style()
	skill_target_style = _make_cell_style()
	feedback_player_style = _make_cell_style()
	feedback_enemy_style = _make_cell_style()
	feedback_skill_style = _make_cell_style()
	feedback_rock_style = _make_cell_style()
	feedback_energy_style = _make_cell_style()
	warning_style = _make_cell_style()
	sealed_style = _make_cell_style()
	player_style = _make_cell_style()
	temporary_player_style = _make_cell_style()
	enemy_style = _make_cell_style()
	last_player_style = _make_cell_style()
	last_enemy_style = _make_cell_style()
...
func _make_cell_style(fill: Color = Color(0, 0, 0, 0), border: Color = Color(0, 0, 0, 0), border_width: int = 0, corner_radius: int = 0, highlight: Color = Color(0, 0, 0, 0)) -> StyleBoxFlat:
	...
	style.bg_color = fill.lerp(highlight, 0.0)
	style.content_margin_left = 0
	style.content_margin_right = 0
	style.content_margin_top = 0
	style.content_margin_bottom = 0
