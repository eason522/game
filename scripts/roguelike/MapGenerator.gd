...
func generate_linear_route() -> Array:
	return [
		...
		_make_node(2, NODE_BATTLE, "急攻之局", "快攻棋士偏向主动连线，逼你及时应对。", EnemyAI.PROFILE_FAST_ATTACKER),
		_make_node(3, NODE_BATTLE, "守势之局", "堡垒棋士会优先堵住你的关键威胁。", EnemyAI.PROFILE_DEFENDER),
		_make_node(4, NODE_BOSS, "岩王之局", "岩王会布置岩阵，并周期性压缩棋盘空间。", EnemyAI.PROFILE_ROCK_BOSS),
	]
